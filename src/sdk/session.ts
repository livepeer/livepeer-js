...
export class Session extends ClientSDK {
    ...
    async getClips(
        ...
        return unwrapAsync(sessionGetClips(this, id, options));
    }
    ...
    async getAll(options?: RequestOptions): Promise<operations.GetSessionsResponse> {
        return unwrapAsync(sessionGetAll(this, options));
    }
    ...
    async get(id: string, options?: RequestOptions): Promise<operations.GetSessionResponse> {
        return unwrapAsync(sessionGet(this, id, options));
    }
    ...
    async getRecorded(
        ...
        return unwrapAsync(sessionGetRecorded(this, parentId, record, options));
    }
}

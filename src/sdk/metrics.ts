...
export class Metrics extends ClientSDK {
    ...
    async getRealtimeViewership(
        ...
        return unwrapAsync(
            metricsGetRealtimeViewership(this, playbackId, creatorId, breakdownBy, options)
        );
    }
    ...
    async getViewership(
        ...
        return unwrapAsync(metricsGetViewership(this, request, options));
    }
    ...
    async getCreatorViewership(
        ...
        return unwrapAsync(metricsGetCreatorViewership(this, request, options));
    }
    ...
    async getPublicViewership(
        ...
        return unwrapAsync(metricsGetPublicViewership(this, playbackId, options));
    }
    ...
    async getUsage(
        ...
        return unwrapAsync(metricsGetUsage(this, request, options));
    }
}

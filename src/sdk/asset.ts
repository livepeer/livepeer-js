...
export class Asset extends ClientSDK {
  ...
  async getAll(
    ...
    return unwrapAsync(assetGetAll(
      this,
      options,
    ));
  }
  ...
  async create(
    ...
    return unwrapAsync(assetCreate(
      this,
      request,
      options,
    ));
  ...
  async createViaUrl(
    ...
    return unwrapAsync(assetCreateViaUrl(
      this,
      request,
      options,
    ));
  ...
  async delete(
    ...
    return unwrapAsync(assetDelete(
      this,
      assetId,
      options,
    ));

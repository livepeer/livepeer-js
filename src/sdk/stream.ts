...
export class Stream extends ClientSDK {
    ...
    async create(
        ...
        return unwrapAsync(streamCreate(this, request, options));
    }
    ...
    async getAll(
        ...
        return unwrapAsync(streamGetAll(this, streamsonly, options));
    }
    ...
    async get(id: string, options?: RequestOptions): Promise<operations.GetStreamResponse> {
        return unwrapAsync(streamGet(this, id, options));
    }
    ...
    async update(
        ...
        return unwrapAsync(streamUpdate(this, id, streamPatchPayload, options));
    }
    ...
    async delete(id: string, options?: RequestOptions): Promise<operations.DeleteStreamResponse> {
        return unwrapAsync(streamDelete(this, id, options));
    }
    ...
    async terminate(
        ...
        return unwrapAsync(streamTerminate(this, id, options));
    }
    ...
    async startPull(
        ...
        return unwrapAsync(streamStartPull(this, id, options));
    }
    ...
    async createClip(
        ...
        return unwrapAsync(streamCreateClip(this, request, options));
    }
    ...
    async getClips(id: string, options?: RequestOptions): Promise<operations.GetClipsResponse> {
        return unwrapAsync(streamGetClips(this, id, options));
    }
    ...
    async addMultistreamTarget(
        ...
        return unwrapAsync(streamAddMultistreamTarget(this, id, targetAddPayload, options));
    }
    ...
    async removeMultistreamTarget(
        ...
        return unwrapAsync(streamRemoveMultistreamTarget(this, id, targetId, options));
    }
}

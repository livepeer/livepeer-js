 ...
 */
export async function roomDeleteUser(
    client$: LivepeerCore,
    id: string,
    userId: string,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.nil(204, operations.DeleteRoomUserResponse$inboundSchema),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.DeleteRoomUserResponse$inboundSchema, { key: "error" })

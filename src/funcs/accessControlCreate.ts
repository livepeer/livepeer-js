...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.CreateSigningKeyResponse$inboundSchema, { key: "signing-key" }),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.CreateSigningKeyResponse$inboundSchema, { key: "error" })

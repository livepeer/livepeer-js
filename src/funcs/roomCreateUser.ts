...
> {
  ...
  const body$ = encodeJSON$("body", payload$["room-user-payload"], {
    explode: true,
  });
  ...
  const path$ = pathToFunc("/room/{id}/user")(pathParams$);
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(201, operations.CreateRoomUserResponse$inboundSchema, {
      key: "room-user-response",
    }),
    m$.fail(["4XX", "5XX"]),
    m$.json("default", operations.CreateRoomUserResponse$inboundSchema, {
      key: "error",
    }),

...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetViewershipMetricsResponse$inboundSchema, { key: "data" }),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.GetViewershipMetricsResponse$inboundSchema, { key: "error" })

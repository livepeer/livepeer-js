...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetRealtimeViewershipNowRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetRealtimeViewershipNowResponse$inboundSchema, { key: "data" }),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.GetRealtimeViewershipNowResponse$inboundSchema, {
            key: "error",
        })

 ...
 */
export async function roomStopEgress(
    client$: LivepeerCore,
    id: string,
...
> {
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.nil(204, operations.StopRoomEgressResponse$inboundSchema),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.StopRoomEgressResponse$inboundSchema, { key: "error" })

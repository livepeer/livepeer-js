...
> {
    ...
    const path$ = pathToFunc("/webhook/{id}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.DeleteWebhookResponse$inboundSchema, { key: "webhook" }),
        m$.fail(["4XX", "5XX"]),
        m$.json("default", operations.DeleteWebhookResponse$inboundSchema, { key: "error" })

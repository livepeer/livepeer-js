...
export namespace GetSessionClipsRequest$ {
    export const inboundSchema: z.ZodType<GetSessionClipsRequest, z.ZodTypeDef, unknown> = z.object(
        {
            id: z.string(),
        }
    );
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetSessionClipsRequest> =
        z.object({
            id: z.string(),
        });
}

...
/** @internal */
export const From$inboundSchema: z.ZodType<From, z.ZodTypeDef, unknown> = z.union([
    z
        .string()
...
/** @internal */
export const From$outboundSchema: z.ZodType<From$Outbound, z.ZodTypeDef, From> = z.union([
...
/** @internal */
export const TimeStep$inboundSchema: z.ZodNativeEnum<typeof TimeStep> = z.nativeEnum(TimeStep);

/** @internal */
export const TimeStep$outboundSchema: z.ZodNativeEnum<typeof TimeStep> = TimeStep$inboundSchema;
...
/** @internal */
export const QueryParamBreakdownBy$inboundSchema: z.ZodNativeEnum<typeof QueryParamBreakdownBy> =
    z.nativeEnum(QueryParamBreakdownBy);

/** @internal */
export const QueryParamBreakdownBy$outboundSchema: z.ZodNativeEnum<typeof QueryParamBreakdownBy> =

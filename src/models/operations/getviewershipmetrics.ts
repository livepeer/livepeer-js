...
export namespace TimeStep$ {
    export const inboundSchema: z.ZodNativeEnum<typeof TimeStep> = z.nativeEnum(TimeStep);
    export const outboundSchema: z.ZodNativeEnum<typeof TimeStep> = inboundSchema;
}

/** @internal */
export namespace BreakdownBy$ {
    export const inboundSchema: z.ZodNativeEnum<typeof BreakdownBy> = z.nativeEnum(BreakdownBy);
    export const outboundSchema: z.ZodNativeEnum<typeof BreakdownBy> = inboundSchema;
}

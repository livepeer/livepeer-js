...
/** @internal */
export const QueryParamFrom$inboundSchema: z.ZodType<QueryParamFrom, z.ZodTypeDef, unknown> =
    z.union([
        z
            .string()
...
/** @internal */
export const QueryParamTo$inboundSchema: z.ZodType<QueryParamTo, z.ZodTypeDef, unknown> = z.union([
    z
        .string()
        .datetime({ offset: true })
        .transform((v) => new Date(v)),
...
/** @internal */
export const QueryParamTimeStep$inboundSchema: z.ZodNativeEnum<typeof QueryParamTimeStep> =
    z.nativeEnum(QueryParamTimeStep);

/** @internal */
export const QueryParamTimeStep$outboundSchema: z.ZodNativeEnum<typeof QueryParamTimeStep> =
...
/** @internal */
export const GetCreatorViewershipMetricsQueryParamBreakdownBy$inboundSchema: z.ZodNativeEnum<
    typeof GetCreatorViewershipMetricsQueryParamBreakdownBy
> = z.nativeEnum(GetCreatorViewershipMetricsQueryParamBreakdownBy);

/** @internal */
export const GetCreatorViewershipMetricsQueryParamBreakdownBy$outboundSchema: z.ZodNativeEnum<
    typeof GetCreatorViewershipMetricsQueryParamBreakdownBy
...
export namespace GetCreatorViewershipMetricsQueryParamBreakdownBy$ {
    ...
    export const inboundSchema = GetCreatorViewershipMetricsQueryParamBreakdownBy$inboundSchema;
    /** @deprecated use `GetCreatorViewershipMetricsQueryParamBreakdownBy$outboundSchema` instead. */
    export const outboundSchema = GetCreatorViewershipMetricsQueryParamBreakdownBy$outboundSchema;
}
...
> = z
    .object({
        ...
        "breakdownBy[]": z
            .array(GetCreatorViewershipMetricsQueryParamBreakdownBy$inboundSchema)
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        from: z.union([z.date().transform((v) => v.toISOString()), z.number().int()]).optional(),
        ...
        creatorId: z.string().optional(),
        breakdownBy: z
            .array(GetCreatorViewershipMetricsQueryParamBreakdownBy$outboundSchema)
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
export namespace GetCreatorViewershipMetricsRequest$ {
    ...
    export const outboundSchema = GetCreatorViewershipMetricsRequest$outboundSchema;
...
export namespace GetCreatorViewershipMetricsResponse$ {
    ...
    export const inboundSchema = GetCreatorViewershipMetricsResponse$inboundSchema;
    /** @deprecated use `GetCreatorViewershipMetricsResponse$outboundSchema` instead. */
    export const outboundSchema = GetCreatorViewershipMetricsResponse$outboundSchema;

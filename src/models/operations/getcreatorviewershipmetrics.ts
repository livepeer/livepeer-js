...
export namespace QueryParamTimeStep$ {
    export const inboundSchema: z.ZodNativeEnum<typeof QueryParamTimeStep> =
        z.nativeEnum(QueryParamTimeStep);
    export const outboundSchema: z.ZodNativeEnum<typeof QueryParamTimeStep> = inboundSchema;
}

/** @internal */
export namespace QueryParamBreakdownBy$ {
    export const inboundSchema: z.ZodNativeEnum<typeof QueryParamBreakdownBy> =
        z.nativeEnum(QueryParamBreakdownBy);
    export const outboundSchema: z.ZodNativeEnum<typeof QueryParamBreakdownBy> = inboundSchema;
}

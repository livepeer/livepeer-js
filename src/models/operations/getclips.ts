...
export namespace GetClipsRequest$ {
    export const inboundSchema: z.ZodType<GetClipsRequest, z.ZodTypeDef, unknown> = z.object({
        id: z.string(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetClipsRequest> = z.object({
        id: z.string(),
    });
}
...
export namespace GetClipsResponse$ {
    export const inboundSchema: z.ZodType<GetClipsResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetClipsResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),

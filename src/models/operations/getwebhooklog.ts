...
export namespace GetWebhookLogRequest$ {
    export const inboundSchema: z.ZodType<GetWebhookLogRequest, z.ZodTypeDef, unknown> = z.object({
        id: z.string(),
        logId: z.string(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetWebhookLogRequest> = z.object(
        {
            id: z.string(),
            logId: z.string(),
        }
...
export namespace GetWebhookLogResponse$ {
    export const inboundSchema: z.ZodType<GetWebhookLogResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetWebhookLogResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),

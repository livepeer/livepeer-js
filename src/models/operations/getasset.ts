...
export namespace GetAssetRequest$ {
    export const inboundSchema: z.ZodType<GetAssetRequest, z.ZodTypeDef, unknown> = z.object({
        assetId: z.string(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetAssetRequest> = z.object({
        assetId: z.string(),
    });
}

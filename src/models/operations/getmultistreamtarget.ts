...
export namespace GetMultistreamTargetRequest$ {
    export const inboundSchema: z.ZodType<GetMultistreamTargetRequest, z.ZodTypeDef, unknown> =
        z.object({
            id: z.string(),
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetMultistreamTargetRequest> =
        z.object({
            id: z.string(),
        });
}

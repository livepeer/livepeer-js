...
export namespace CreateClipTask$ {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateClipTask> = z
        .object({
            id: z.string().optional(),
        })
        .transform((v) => {
...
export namespace CreateClipData$ {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateClipData> = z
        .object({

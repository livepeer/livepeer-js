...
export namespace DeleteStreamRequest$ {
    ...
    export const inboundSchema: z.ZodType<DeleteStreamRequest, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.string(),
        })
        .transform((v) => {
...
export namespace DeleteStreamResponse$ {
    ...
    export const inboundSchema: z.ZodType<DeleteStreamResponse, z.ZodTypeDef, Inbound> = z
        .object({

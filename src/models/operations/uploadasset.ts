...
/** @internal */
export const UploadAssetTask$inboundSchema: z.ZodType<UploadAssetTask, z.ZodTypeDef, unknown> =
    z.object({
        id: z.string(),
    });
...
/** @internal */
export const UploadAssetData$inboundSchema: z.ZodType<UploadAssetData, z.ZodTypeDef, unknown> =
    z.object({
        asset: components.Asset$inboundSchema,
...
> = z
    .object({
        ...
        "201_application/json_data": z.lazy(() => UploadAssetDataOutput$inboundSchema).optional(),

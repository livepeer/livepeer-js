...
export namespace RequestUploadData$ {
    export const inboundSchema: z.ZodType<RequestUploadData, z.ZodTypeDef, unknown> = z.object({
        url: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RequestUploadData> = z.object({
        url: z.string(),
        tusEndpoint: z.string(),
...
export namespace RequestUploadResponse$ {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, RequestUploadResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),

...
export namespace GetUsageMetricsQueryParamTimeStep$ {
    ...
    export const outboundSchema = GetUsageMetricsQueryParamTimeStep$outboundSchema;
}

/** @internal */
export const GetUsageMetricsQueryParamBreakdownBy$inboundSchema: z.ZodNativeEnum<
    typeof GetUsageMetricsQueryParamBreakdownBy
> = z.nativeEnum(GetUsageMetricsQueryParamBreakdownBy);

/** @internal */
export const GetUsageMetricsQueryParamBreakdownBy$outboundSchema: z.ZodNativeEnum<
    typeof GetUsageMetricsQueryParamBreakdownBy
...
export namespace GetUsageMetricsQueryParamBreakdownBy$ {
    ...
    export const inboundSchema = GetUsageMetricsQueryParamBreakdownBy$inboundSchema;
    /** @deprecated use `GetUsageMetricsQueryParamBreakdownBy$outboundSchema` instead. */
    export const outboundSchema = GetUsageMetricsQueryParamBreakdownBy$outboundSchema;
}
...
> = z
    .object({
        ...
        "breakdownBy[]": z.array(GetUsageMetricsQueryParamBreakdownBy$inboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {

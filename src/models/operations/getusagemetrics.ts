...
export namespace GetUsageMetricsQueryParamTimeStep$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetUsageMetricsQueryParamTimeStep> =
        z.nativeEnum(GetUsageMetricsQueryParamTimeStep);
    export const outboundSchema: z.ZodNativeEnum<typeof GetUsageMetricsQueryParamTimeStep> =
        inboundSchema;
}

/** @internal */
export namespace GetUsageMetricsQueryParamBreakdownBy$ {
    export const inboundSchema: z.ZodNativeEnum<typeof GetUsageMetricsQueryParamBreakdownBy> =
        z.nativeEnum(GetUsageMetricsQueryParamBreakdownBy);
    export const outboundSchema: z.ZodNativeEnum<typeof GetUsageMetricsQueryParamBreakdownBy> =
        inboundSchema;
}

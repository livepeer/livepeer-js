...
export namespace GetPublicViewershipMetricsRequest$ {
    ...
    export const outboundSchema = GetPublicViewershipMetricsRequest$outboundSchema;
...
export namespace GetPublicViewershipMetricsResponse$ {
    ...
    export const outboundSchema = GetPublicViewershipMetricsResponse$outboundSchema;

...
export namespace UpdateWebhookRequest$ {
    export const inboundSchema: z.ZodType<UpdateWebhookRequest, z.ZodTypeDef, unknown> = z.object({
        id: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateWebhookRequest> = z.object(
        {
            id: z.string(),

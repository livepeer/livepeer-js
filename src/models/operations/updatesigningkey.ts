...
export namespace UpdateSigningKeyRequestBody$ {
    export const inboundSchema: z.ZodType<UpdateSigningKeyRequestBody, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateSigningKeyRequestBody> =
        z.object({
            disabled: z.boolean().optional(),
            name: z.string().optional(),
        });

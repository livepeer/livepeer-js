...
export namespace IpfsExportParams2$ {
    export const inboundSchema: z.ZodType<IpfsExportParams2, z.ZodTypeDef, unknown> = z.object({
        apiKey: z.string(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, IpfsExportParams2> = z.object({
        apiKey: z.string(),
    });
}

...
/** @internal */
export const IpfsExportParams2$inboundSchema: z.ZodType<IpfsExportParams2, z.ZodTypeDef, unknown> =
    z.object({
        apiKey: z.string(),
    });
...
/** @internal */
export const IpfsExportParams1$inboundSchema: z.ZodType<IpfsExportParams1, z.ZodTypeDef, unknown> =
    z.object({});
...
/** @internal */
export const Pinata$inboundSchema: z.ZodType<Pinata, z.ZodTypeDef, unknown> = z.union([
...
/** @internal */
export const Pinata$outboundSchema: z.ZodType<Pinata$Outbound, z.ZodTypeDef, Pinata> = z.union([
...
/** @internal */
export const IpfsExportParams$inboundSchema: z.ZodType<IpfsExportParams, z.ZodTypeDef, unknown> = z
    .object({
        $ref: z.any().optional(),
        pinata: z
            .union([

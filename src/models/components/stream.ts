...
import { TargetOutput, TargetOutput$ } from "./targetoutput.js";
...
export namespace Stream1$ {
    export const inboundSchema: z.ZodNativeEnum<typeof Stream1> = z.nativeEnum(Stream1);
    export const outboundSchema: z.ZodNativeEnum<typeof Stream1> = inboundSchema;
}

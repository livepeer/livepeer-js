...
/** @internal */
export const Stream3$inboundSchema: z.ZodType<Stream3, z.ZodTypeDef, unknown> = z.union([
    z.string(),
    z.number(),
]);
...
/** @internal */
export const Stream3$outboundSchema: z.ZodType<Stream3$Outbound, z.ZodTypeDef, Stream3> = z.union([
    z.string(),
    z.number(),
]);
...
/** @internal */
export const StreamUserTags$inboundSchema: z.ZodType<StreamUserTags, z.ZodTypeDef, unknown> =
...
/** @internal */
export const Stream1$inboundSchema: z.ZodNativeEnum<typeof Stream1> = z.nativeEnum(Stream1);

/** @internal */
export const Stream1$outboundSchema: z.ZodNativeEnum<typeof Stream1> = Stream1$inboundSchema;
...
/** @internal */
export const StreamIsMobile$inboundSchema: z.ZodType<StreamIsMobile, z.ZodTypeDef, unknown> =
...
/** @internal */
export const StreamLocation$inboundSchema: z.ZodType<StreamLocation, z.ZodTypeDef, unknown> =
    z.object({
        lat: z.number(),
        lon: z.number(),
    });
...
/** @internal */
export const StreamPull$inboundSchema: z.ZodType<StreamPull, z.ZodTypeDef, unknown> = z.object({
    source: z.string(),
...
/** @internal */
export const StreamPull$outboundSchema: z.ZodType<StreamPull$Outbound, z.ZodTypeDef, StreamPull> =
    z.object({
        source: z.string(),
        headers: z.record(z.string()).optional(),
...
/** @internal */
export const StreamMultistream$inboundSchema: z.ZodType<StreamMultistream, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const Renditions$inboundSchema: z.ZodType<Renditions, z.ZodTypeDef, unknown> = z.object({});

/** @internal */
export type Renditions$Outbound = {};

/** @internal */
export const Renditions$outboundSchema: z.ZodType<Renditions$Outbound, z.ZodTypeDef, Renditions> =
    z.object({});

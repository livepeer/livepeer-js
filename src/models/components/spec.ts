...
/** @internal */
export const NftMetadataTemplate$inboundSchema: z.ZodNativeEnum<
  typeof NftMetadataTemplate
> = z.nativeEnum(NftMetadataTemplate);

/** @internal */
export const NftMetadataTemplate$outboundSchema: z.ZodNativeEnum<
  typeof NftMetadataTemplate
...
/** @internal */
export const NftMetadata$inboundSchema: z.ZodType<
  NftMetadata,
  z.ZodTypeDef,
  unknown
> = z.object({});

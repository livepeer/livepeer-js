...
/** @internal */
export const PrimaryType$inboundSchema: z.ZodNativeEnum<typeof PrimaryType> =
    z.nativeEnum(PrimaryType);
...
/** @internal */
export const Domain$inboundSchema: z.ZodType<Domain, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Domain$outboundSchema: z.ZodType<Domain$Outbound, z.ZodTypeDef, Domain> = z.object({
...
/** @internal */
export const Attestations$inboundSchema: z.ZodType<Attestations, z.ZodTypeDef, unknown> = z.object({
    role: z.string(),
    address: z.string(),
});
...
/** @internal */
export const SignatureType$inboundSchema: z.ZodNativeEnum<typeof SignatureType> =
    z.nativeEnum(SignatureType);

/** @internal */
export const SignatureType$outboundSchema: z.ZodNativeEnum<typeof SignatureType> =
...
/** @internal */
export const AttestationIpfs$inboundSchema: z.ZodType<AttestationIpfs, z.ZodTypeDef, unknown> = z
    .object({
        $ref: z.any().optional(),
...
/** @internal */
export const Attestation$inboundSchema: z.ZodType<Attestation, z.ZodTypeDef, unknown> = z.object({

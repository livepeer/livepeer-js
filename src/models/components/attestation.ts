...
export namespace PrimaryType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PrimaryType> = z.nativeEnum(PrimaryType);
    export const outboundSchema: z.ZodNativeEnum<typeof PrimaryType> = inboundSchema;
}

/** @internal */
export namespace Name$ {
    export const inboundSchema: z.ZodNativeEnum<typeof Name> = z.nativeEnum(Name);
    export const outboundSchema: z.ZodNativeEnum<typeof Name> = inboundSchema;
}
...
export namespace SignatureType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof SignatureType> = z.nativeEnum(SignatureType);
    export const outboundSchema: z.ZodNativeEnum<typeof SignatureType> = inboundSchema;
}

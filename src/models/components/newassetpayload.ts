...
/** @internal */
export const NewAssetPayload1$inboundSchema: z.ZodType<NewAssetPayload1, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const NewAssetPayload$inboundSchema: z.ZodType<NewAssetPayload, z.ZodTypeDef, unknown> =
    z.object({
        name: z.string(),

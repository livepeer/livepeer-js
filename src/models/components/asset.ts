...
/** @internal */
export const AssetType$inboundSchema: z.ZodNativeEnum<typeof AssetType> = z.nativeEnum(AssetType);

/** @internal */
export const AssetType$outboundSchema: z.ZodNativeEnum<typeof AssetType> = AssetType$inboundSchema;
...
/** @internal */
export const Asset3$inboundSchema: z.ZodType<Asset3, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Asset3$outboundSchema: z.ZodType<Asset3$Outbound, z.ZodTypeDef, Asset3> = z.object({
...
/** @internal */
export const AssetSchemasSourceType$inboundSchema: z.ZodNativeEnum<typeof AssetSchemasSourceType> =
    z.nativeEnum(AssetSchemasSourceType);

/** @internal */
export const AssetSchemasSourceType$outboundSchema: z.ZodNativeEnum<typeof AssetSchemasSourceType> =
...
/** @internal */
export const AssetSchemasType$inboundSchema: z.ZodNativeEnum<typeof AssetSchemasType> =
    z.nativeEnum(AssetSchemasType);

/** @internal */
export const AssetSchemasType$outboundSchema: z.ZodNativeEnum<typeof AssetSchemasType> =
...
/** @internal */
export const Asset1$inboundSchema: z.ZodType<Asset1, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Asset1$outboundSchema: z.ZodType<Asset1$Outbound, z.ZodTypeDef, Asset1> = z.object({
...
/** @internal */
export const AssetNftMetadata$inboundSchema: z.ZodType<AssetNftMetadata, z.ZodTypeDef, unknown> =
    z.object({});
...
/** @internal */
export const AssetSpec$inboundSchema: z.ZodType<AssetSpec, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const AssetSpec$outboundSchema: z.ZodType<AssetSpec$Outbound, z.ZodTypeDef, AssetSpec> =
    z.object({
...
/** @internal */
export const AssetIpfs$inboundSchema: z.ZodType<AssetIpfs, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const AssetIpfs$outboundSchema: z.ZodType<AssetIpfs$Outbound, z.ZodTypeDef, AssetIpfs> = z
    .object({
...
/** @internal */
export const AssetStorage$inboundSchema: z.ZodType<AssetStorage, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const AssetPhase$inboundSchema: z.ZodNativeEnum<typeof AssetPhase> =
    z.nativeEnum(AssetPhase);
...
/** @internal */
export const AssetStatus$inboundSchema: z.ZodType<AssetStatus, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Hash$inboundSchema: z.ZodType<Hash, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Hash$outboundSchema: z.ZodType<Hash$Outbound, z.ZodTypeDef, Hash> = z.object({
    hash: z.string().optional(),
    algorithm: z.string().optional(),
});
...
/** @internal */
export const Tracks$inboundSchema: z.ZodType<Tracks, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const Tracks$outboundSchema: z.ZodType<Tracks$Outbound, z.ZodTypeDef, Tracks> = z.object({
...
/** @internal */
export const VideoSpec$inboundSchema: z.ZodType<VideoSpec, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const VideoSpec$outboundSchema: z.ZodType<VideoSpec$Outbound, z.ZodTypeDef, VideoSpec> =
    z.object({
        format: z.string().optional(),
        duration: z.number().optional(),
        bitrate: z.number().optional(),
...
/** @internal */
export const Asset$inboundSchema: z.ZodType<Asset, z.ZodTypeDef, unknown> = z.object({
    id: z.string(),
...
/** @internal */
export const Asset$outboundSchema: z.ZodType<Asset$Outbound, z.ZodTypeDef, Asset> = z.object({
    id: z.string(),

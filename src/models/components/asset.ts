...
import { CreatorId, CreatorId$ } from "./creatorid.js";
import { EncryptionOutput, EncryptionOutput$ } from "./encryptionoutput.js";
import { IpfsFileInfo, IpfsFileInfo$ } from "./ipfsfileinfo.js";
import { PlaybackPolicy, PlaybackPolicy$ } from "./playbackpolicy.js";
import { StorageStatus, StorageStatus$ } from "./storagestatus.js";
...
export namespace AssetType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof AssetType> = z.nativeEnum(AssetType);
    export const outboundSchema: z.ZodNativeEnum<typeof AssetType> = inboundSchema;
}

/** @internal */
export namespace AssetSchemasSource3Type$ {
    export const inboundSchema: z.ZodNativeEnum<typeof AssetSchemasSource3Type> =
        z.nativeEnum(AssetSchemasSource3Type);
    export const outboundSchema: z.ZodNativeEnum<typeof AssetSchemasSource3Type> = inboundSchema;
}
...
export namespace AssetSchemasSourceType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof AssetSchemasSourceType> =
        z.nativeEnum(AssetSchemasSourceType);
    export const outboundSchema: z.ZodNativeEnum<typeof AssetSchemasSourceType> = inboundSchema;
}
...
export namespace AssetSchemasType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof AssetSchemasType> =
        z.nativeEnum(AssetSchemasType);
    export const outboundSchema: z.ZodNativeEnum<typeof AssetSchemasType> = inboundSchema;
}
...
export namespace AssetNftMetadataTemplate$ {
    export const inboundSchema: z.ZodNativeEnum<typeof AssetNftMetadataTemplate> =
        z.nativeEnum(AssetNftMetadataTemplate);
    export const outboundSchema: z.ZodNativeEnum<typeof AssetNftMetadataTemplate> = inboundSchema;
}
...
export namespace AssetPhase$ {
    export const inboundSchema: z.ZodNativeEnum<typeof AssetPhase> = z.nativeEnum(AssetPhase);
    export const outboundSchema: z.ZodNativeEnum<typeof AssetPhase> = inboundSchema;
}
...
export namespace AssetSchemasVideoSpecType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof AssetSchemasVideoSpecType> =
        z.nativeEnum(AssetSchemasVideoSpecType);
    export const outboundSchema: z.ZodNativeEnum<typeof AssetSchemasVideoSpecType> = inboundSchema;
}

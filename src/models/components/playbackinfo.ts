...
/** @internal */
export const PlaybackInfoType$inboundSchema: z.ZodNativeEnum<typeof PlaybackInfoType> =
    z.nativeEnum(PlaybackInfoType);

/** @internal */
export const PlaybackInfoType$outboundSchema: z.ZodNativeEnum<typeof PlaybackInfoType> =
...
/** @internal */
export const Live$inboundSchema: z.ZodNativeEnum<typeof Live> = z.nativeEnum(Live);

/** @internal */
export const Live$outboundSchema: z.ZodNativeEnum<typeof Live> = Live$inboundSchema;
...
/** @internal */
export const Hrn$outboundSchema: z.ZodNativeEnum<typeof Hrn> = Hrn$inboundSchema;
...
/** @internal */
export const PlaybackInfoHrn$inboundSchema: z.ZodNativeEnum<typeof PlaybackInfoHrn> =
    z.nativeEnum(PlaybackInfoHrn);

/** @internal */
export const PlaybackInfoHrn$outboundSchema: z.ZodNativeEnum<typeof PlaybackInfoHrn> =
...
/** @internal */
export const DvrPlayback$inboundSchema: z.ZodType<DvrPlayback, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const PlaybackInfo$inboundSchema: z.ZodType<PlaybackInfo, z.ZodTypeDef, unknown> = z.object({

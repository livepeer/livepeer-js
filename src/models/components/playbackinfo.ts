...
import { Attestation, Attestation$ } from "./attestation.js";
...
export namespace PlaybackInfoType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PlaybackInfoType> =
        z.nativeEnum(PlaybackInfoType);
    export const outboundSchema: z.ZodNativeEnum<typeof PlaybackInfoType> = inboundSchema;
}

/** @internal */
export namespace Live$ {
    export const inboundSchema: z.ZodNativeEnum<typeof Live> = z.nativeEnum(Live);
    export const outboundSchema: z.ZodNativeEnum<typeof Live> = inboundSchema;
}

/** @internal */
export namespace Hrn$ {
    export const inboundSchema: z.ZodNativeEnum<typeof Hrn> = z.nativeEnum(Hrn);
    export const outboundSchema: z.ZodNativeEnum<typeof Hrn> = inboundSchema;
}

/** @internal */
export namespace PlaybackInfoSchemasType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PlaybackInfoSchemasType> =
        z.nativeEnum(PlaybackInfoSchemasType);
    export const outboundSchema: z.ZodNativeEnum<typeof PlaybackInfoSchemasType> = inboundSchema;
}
...
export namespace PlaybackInfoHrn$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PlaybackInfoHrn> =
        z.nativeEnum(PlaybackInfoHrn);
    export const outboundSchema: z.ZodNativeEnum<typeof PlaybackInfoHrn> = inboundSchema;
}

/** @internal */
export namespace PlaybackInfoSchemasMetaType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof PlaybackInfoSchemasMetaType> = z.nativeEnum(
        PlaybackInfoSchemasMetaType
    );
    export const outboundSchema: z.ZodNativeEnum<typeof PlaybackInfoSchemasMetaType> =
        inboundSchema;
}

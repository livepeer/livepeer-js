...
import { Target, Target$inboundSchema, Target$Outbound, Target$outboundSchema } from "./target.js";
...
/** @internal */
export const Multistream$inboundSchema: z.ZodType<Multistream, z.ZodTypeDef, unknown> = z.object({

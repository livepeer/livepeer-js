...
/** @internal */
export const Storage1$inboundSchema: z.ZodType<
  Storage1,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const Storage1$outboundSchema: z.ZodType<
  Storage1$Outbound,
  z.ZodTypeDef,
  Storage1
> = z.object({
...
/** @internal */
export const Ipfs$outboundSchema: z.ZodType<Ipfs$Outbound, z.ZodTypeDef, Ipfs> =
  z.union([z.lazy(() => Storage1$outboundSchema), z.boolean()]);
...
export const Storage$inboundSchema: z.ZodType<Storage, z.ZodTypeDef, unknown> =
  z.object({
    ipfs: z.nullable(
      z.union([z.lazy(() => Storage1$inboundSchema), z.boolean()]),
    ).optional(),
  });

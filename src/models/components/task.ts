...
/** @internal */
export const TaskExportData$inboundSchema: z.ZodType<
  TaskExportData,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const TaskStorage$inboundSchema: z.ZodType<
  TaskStorage,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const TaskHls$outboundSchema: z.ZodType<
  TaskHls$Outbound,
  z.ZodTypeDef,
  TaskHls
> = z.object({
...
/** @internal */
export const TaskMp4$outboundSchema: z.ZodType<
  TaskMp4$Outbound,
  z.ZodTypeDef,
  TaskMp4
> = z.object({
...
/** @internal */
export const TaskOutputs$inboundSchema: z.ZodType<
  TaskOutputs,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const TranscodeFile$inboundSchema: z.ZodType<
  TranscodeFile,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const Clip$inboundSchema: z.ZodType<Clip, z.ZodTypeDef, unknown> = z
  .object({
    url: z.string().optional(),
...
/** @internal */
export const Clip$outboundSchema: z.ZodType<Clip$Outbound, z.ZodTypeDef, Clip> =
  z.object({
    url: z.string().optional(),
    clipStrategy: z.lazy(() => ClipStrategy$outboundSchema).optional(),
    catalystPipelineStrategy: CatalystPipelineStrategy$outboundSchema
      .optional(),
    sessionId: z.string().optional(),
    inputId: z.string().optional(),
  });
...
/** @internal */
export const TaskPhase$inboundSchema: z.ZodNativeEnum<typeof TaskPhase> = z
  .nativeEnum(TaskPhase);

/** @internal */
export const TaskPhase$outboundSchema: z.ZodNativeEnum<typeof TaskPhase> =
  TaskPhase$inboundSchema;
...
/** @internal */
export const TaskUpload$outboundSchema: z.ZodType<
  TaskUpload$Outbound,
  z.ZodTypeDef,
  TaskUpload
> = z.object({
...
/** @internal */
export const TaskIpfs$inboundSchema: z.ZodType<
  TaskIpfs,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const TaskIpfs$outboundSchema: z.ZodType<
  TaskIpfs$Outbound,
  z.ZodTypeDef,
  TaskIpfs
> = z.object({
...
/** @internal */
export const TaskSchemasIpfs$inboundSchema: z.ZodType<
  TaskSchemasIpfs,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ExportData$outboundSchema: z.ZodType<
  ExportData$Outbound,
  z.ZodTypeDef,
  ExportData
> = z.object({

...
import { Asset, Asset$ } from "./asset.js";
import { EncryptionOutput, EncryptionOutput$ } from "./encryptionoutput.js";
import { ExportTaskParams, ExportTaskParams$ } from "./exporttaskparams.js";
import { InputCreatorId, InputCreatorId$ } from "./inputcreatorid.js";
import { IpfsExportParams, IpfsExportParams$ } from "./ipfsexportparams.js";
...
export namespace TaskType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof TaskType> = z.nativeEnum(TaskType);
    export const outboundSchema: z.ZodNativeEnum<typeof TaskType> = inboundSchema;
}
...
export namespace CatalystPipelineStrategy$ {
    export const inboundSchema: z.ZodNativeEnum<typeof CatalystPipelineStrategy> =
        z.nativeEnum(CatalystPipelineStrategy);
    export const outboundSchema: z.ZodNativeEnum<typeof CatalystPipelineStrategy> = inboundSchema;
}
...
export namespace TaskPhase$ {
    export const inboundSchema: z.ZodNativeEnum<typeof TaskPhase> = z.nativeEnum(TaskPhase);
    export const outboundSchema: z.ZodNativeEnum<typeof TaskPhase> = inboundSchema;
}

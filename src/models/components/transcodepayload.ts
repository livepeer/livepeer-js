...
/** @internal */
export const TranscodePayloadType$inboundSchema: z.ZodNativeEnum<typeof TranscodePayloadType> =
    z.nativeEnum(TranscodePayloadType);

/** @internal */
export const TranscodePayloadType$outboundSchema: z.ZodNativeEnum<typeof TranscodePayloadType> =
...
/** @internal */
export const TranscodePayload2$inboundSchema: z.ZodType<TranscodePayload2, z.ZodTypeDef, unknown> =
    z.object({
...
/** @internal */
export const TranscodePayload1$inboundSchema: z.ZodType<TranscodePayload1, z.ZodTypeDef, unknown> =
    z.object({
        url: z.string(),
    });
...
export namespace TranscodePayloadSchemasStorageType$ {
    ...
    export const outboundSchema = TranscodePayloadSchemasStorageType$outboundSchema;
}
...
export namespace TranscodePayloadSchemasCredentials$ {
    ...
    export const outboundSchema = TranscodePayloadSchemasCredentials$outboundSchema;
...
/** @internal */
export const Hls$inboundSchema: z.ZodType<Hls, z.ZodTypeDef, unknown> = z.object({
    path: z.string(),
});
...
/** @internal */
export const Hls$outboundSchema: z.ZodType<Hls$Outbound, z.ZodTypeDef, Hls> = z.object({
    path: z.string(),
});
...
/** @internal */
export const Mp4$inboundSchema: z.ZodType<Mp4, z.ZodTypeDef, unknown> = z.object({
    path: z.string(),
});
...
/** @internal */
export const Mp4$outboundSchema: z.ZodType<Mp4$Outbound, z.ZodTypeDef, Mp4> = z.object({
    path: z.string(),
});
...
/** @internal */
export const Fmp4$inboundSchema: z.ZodType<Fmp4, z.ZodTypeDef, unknown> = z.object({
    path: z.string(),
});
...
/** @internal */
export const Fmp4$outboundSchema: z.ZodType<Fmp4$Outbound, z.ZodTypeDef, Fmp4> = z.object({
    path: z.string(),
});
...
/** @internal */
export const TranscodePayload$inboundSchema: z.ZodType<TranscodePayload, z.ZodTypeDef, unknown> =
    z.object({
        input: z.union([
            z.lazy(() => TranscodePayload1$inboundSchema),
            z.lazy(() => TranscodePayload2$inboundSchema),

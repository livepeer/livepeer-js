...
```typescript
import { Pull } from "livepeer/models/components";
...
| `isMobile`                                                                                                                      | *components.IsMobile*                                                                                                           | :heavy_minus_sign:                                                                                                              | Indicates whether the stream will be pulled from a mobile source.                                                               |                                                                                                                                 |
